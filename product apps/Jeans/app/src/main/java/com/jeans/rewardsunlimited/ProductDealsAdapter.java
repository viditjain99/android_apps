...
public class ProductDealsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i)
    {
        if(i==AD_ITEM || i==CK_AD_ITEM)
        {
            ...
            return new AdsViewHolder(inflater.inflate(R.layout.ad_container,viewGroup,false));
        }
        LayoutInflater inflater= (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        //View rowLayout=inflater.inflate(R.layout.product_deals_row_layout,viewGroup,false);
        return new ProductDealsViewHolder(inflater.inflate(R.layout.product_deals_row_layout,viewGroup,false));
    }
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder viewHolder, int i)
    {
        if(getItemViewType(i)==AD_ITEM)
        {
            ...
            ViewGroup adCardView=adsViewHolder.adCardView;
        ...
        else if(getItemViewType(i)==DEAL_ITEM)
        {
            ...
            if(!productDeal.isInStock.equals("0"))
            {
                ...
                productDealsViewHolder.buyNowButton.setBackgroundColor(Color.parseColor("#7397B1"));
