...
public class MainActivity extends AppCompatActivity implements ProductSliderClickListener, NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_share)        //app share button clicked
        {
            ...
            intent.putExtra(Intent.EXTRA_TEXT,"For the best deals on jeans check out this app at https://play.google.com/store/apps/details?id=com.jeans.rewardsunlimited&hl=en");
            startActivity(intent);
        }
    ...
    public void loadData()
    {
        ...
        MobileAds.initialize(MainActivity.this,"ca-app-pub-5162888426019346/6715228883");       //initialise mobile ads
