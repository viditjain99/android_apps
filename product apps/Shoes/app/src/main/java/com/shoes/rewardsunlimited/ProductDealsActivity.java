...
public class ProductDealsActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener
{
    ...
    String[] searchKey;
    String adUnitId="ca-app-pub-5162888426019346/9043500017";
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        MobileAds.initialize(this,"ca-app-pub-5162888426019346~5358625628");
                ...
                if(productsResponse!=null)
                {
                    ...
                    if(searchKeyString==null)
                    {
                        ...
                        for(int i=0;i<temp.size();i++)
                        {
                            ...
                            if(gender.equals("Men") && category.equals("Men Footwear"))
                            {
                            ...
                            else if(gender.equals("Women") && category.equals("Women Footwear"))
                            {
                                Product product=temp.get(i);
                                DecimalFormat decimalFormat=new DecimalFormat("0.00");
                                if(!product.imageUrl1.equals("null"))
                    ...
                    else
                    {
                        if(brand==null)
                        {
                            for(int i=0;i<allProducts.size();i++)
                            {
                                if(allProducts.get(i).retailerName.toLowerCase().equals(retailerName.toLowerCase()) && allProducts.get(i).retailerCategory.equals(path) && allProducts.get(i).isInStock.equals("1"))
                                {
                        ...
                        else
                        {
                            for(int i=0;i<allProducts.size();i++)
                            {
                                if(allProducts.get(i).retailerName.toLowerCase().equals(retailerName.toLowerCase()) && allProducts.get(i).brand.toLowerCase().equals(brand.toLowerCase()) && allProducts.get(i).retailerCategory.equals(path) && allProducts.get(i).isInStock.equals("1"))
                                {
                                    Product product=allProducts.get(i);
                                    DecimalFormat decimalFormat=new DecimalFormat("0.00");
                                    if(!product.imageUrl1.equals("null"))
